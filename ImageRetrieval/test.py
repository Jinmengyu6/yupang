...
if __name__ == "__main__":
  deep = DeepFeat()
  img1, conf1 = deep('1.png')
  img2, conf2 = deep('2.png')
  img3, conf3 = deep('3.png')
  print(img1)
  d12 = deep.match(img1, img2)
  d13 = deep.match(img1, img3)
  d23 = deep.match(img2, img3)
  print(d12, d13, d23)
  # print(conf1,conf2,conf3)
  print(min([d12, d13, d23]))
